...
async def test_correct_fastqc(tmpdir, run_subprocess, run_in_executor, data_regression, analysis_files):
    ...
    await run_in_executor(shutil.copyfile, analysis_files / "paired_small_1.fq.gz", work_path / "reads_1.fq.gz")
    await run_in_executor(shutil.copyfile, analysis_files / "paired_small_2.fq.gz", work_path / "reads_2.fq.gz")
