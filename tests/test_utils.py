...
from virtool_workflow.utils import configure_logs, normalize_log_level
...
class TestLogConfiguration:
    """Tests for configure_logs function."""
    ...
    def test_logger_reconfiguration_works(self):
        """Verify existing loggers work properly after configure_logs is called."""
        buffer, _ = capture_log_output()
